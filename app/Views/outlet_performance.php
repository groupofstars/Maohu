...
<div class="card card-flush">
    ...
    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
        ...
        <div class="card-toolbar">
            <!--begin::Add customer-->
            <a href="/add_outlet_promotion_item" class="btn btn-primary">Add Promotion Item</a>
            <!--end::Add customer-->
        </div>
        <?php endif;?>
        <!--end::Card toolbar-->
...
<script>
    $('a.edit').click(function(){
        ...
        location.href="/outlet_promotion_item_edit?item_id="+$(this).attr("item_id");
    });
    $('a.delete').click(function(){
        var flag=false;
        $.ajax({
            url: "/promotion_item_delete",
            type: "POST",
            data:{
