    ...
    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body text-center pt-0">
                ...
                <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style='background-image: url(uploads/<?php echo ($item["avatar"] == "")? "blank-image.svg" : $item["avatar"];?>)'>
                    ...
                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
                        ...
                        <!--end::Icon-->
                        <!--begin::Inputs-->
                        <input type="file" id="asdf" value="<?=$item['avatar'];?>" name="avatar" accept=".png, .jpg, .jpeg" />
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
                ...
                <select name="status" class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" >
                    <option></option>
                    <option value="Published" <?= $item['status']=="Published" ? 'selected="selected"' : ""; ?> >Published</option>
                    <option value="Scheduled" <?= $item['status']=="Scheduled" ? 'selected="selected"' : ""; ?>>Scheduled</option>
                    <option value="Unpublished" <?= $item['status']=="Unpublished" ? 'selected="selected"' : ""; ?>>Unpublished</option>
                </select>
                <!--end::Select2-->
                <!--begin::Description-->
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
                ...
                <div class="mb-10 fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="name" class="form-control mb-2" placeholder="Product name" value="<?=$item['name'];?>" />
                    <!--end::Input-->
                    <!--begin::Description-->
...
$(document).ready(function(){
    $(".ql-editor").html("<?=$item['description']?>");
    (()=>{
        let e;
